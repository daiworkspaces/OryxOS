      ...
      <div class="hero-shell">
        <div class="hero-copy">
          ...
          <div class="hero-actions">
            ...
            <a class="button secondary" href="https://github.com/daiworkspaces/OryxOS.git" target="_blank" rel="noreferrer">
              GitHub <span>↗</span>
            </a>
          </div>
      ...
      <div class="launch-shell">
        <div class="launch-copy">
          ...
          <div class="launch-actions">
            <a class="button primary" href="https://github.com/daiworkspaces/OryxOS.git" target="_blank" rel="noreferrer">{{ t('开始构建', 'Start building') }} →</a>
...
<span class="cursor">█</span></code></pre>
    ...
    <footer class="site-footer">
      ...
      <a href="https://github.com/daiworkspaces/OryxOS.git">github.com/daiworkspaces/OryxOS ↗</a>
    </footer>
  </main>
</template>
...
.section-index { margin-bottom: 34px; color: #777a80; font: 600 11px/1 'SFMono-Regular', Consolas, monospace; letter-spacing: .16em; }
...
.status-chip { display: inline-flex; align-items: center; gap: 10px; margin-bottom: 30px; color: #aeb3bd; font: 500 10px/1 'SFMono-Regular', Consolas, monospace; letter-spacing: .12em; }
...
.hero-proof strong { color: #f8f6f0; font: 500 24px/1 'SFMono-Regular', Consolas, monospace; }
...
.console-live { margin-left: auto; color: var(--mint); font: 600 9px/1 'SFMono-Regular', Consolas,monospace; }
.console-command { display: flex; gap: 12px; padding: 23px 20px; border-bottom: 1px solid #20242b; color: #eceae4; font: 500 13px/1.6 'SFMono-Regular', Consolas,monospace; }
.console-command .prompt { color: var(--orange); }
.console-flow { padding: 16px 20px 18px; }
.flow-row { display: grid; grid-template-columns: 24px 36px 1fr auto; gap: 10px; align-items: center; min-height: 42px; color: #afb4bd; font: 500 11px/1 'SFMono-Regular', Consolas,monospace; }
...
.console-agent small { display:block;color:var(--orange);font:600 8px/1 'SFMono-Regular', Consolas,monospace;letter-spacing:.12em}.console-agent strong{display:block;margin-top:6px;color:#f4f1eb;font:500 12px/1 'SFMono-Regular', Consolas,monospace}.console-agent>code{color:#59606c;font-size:9px}
.hero-rail { display:flex;align-items:center;justify-content:center;gap:22px;width:min(1240px,100%);height:64px;margin:20px auto 0;border-top:1px solid #272b33;color:#5f6571;font:500 9px/1 'SFMono-Regular', Consolas,monospace;letter-spacing:.17em}.hero-rail i{width:26px;height:1px;background:#393e47}
